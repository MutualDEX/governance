...
describe('scenario:setFeeTo', () => {
  ...
  beforeEach('deploy bigswap v2', async () => {
    factory = await deployContract(wallet, BigswapV2Factory, [timelock.address])
  })
  ...
  it('setFeeTo', async () => {
    ...
    const description = 'Set feeTo on the BigswapV2Factory to the timelock address.'

    // activate balances
    await bgsp.delegate(wallet.address)
